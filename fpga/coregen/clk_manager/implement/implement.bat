...
xst -ifn xst.scr
move clk_manager_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_manager_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_manager_exdes.ucf clk_manager_exdes

echo 'Running map'
map -timing -pr b clk_manager_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_manager_exdes -w routed.ncd routed.vhd
cd ..
